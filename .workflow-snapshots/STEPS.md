...
### Objective gates
- [ ] [P3C.O1] Network/auth and tool schema tests pass
- [ ] [P3C.O2] Stale/deny tests confirm mutations require confirmation and revision guards

### Judgment gates
- [ ] [P3C.J1] Every mutation is permission-gated and audit-logged
